...
const CardList = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/1655329/pexels-photo-1655329.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
      }}
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 mt-12 p-6">
        <Card />
        <Card />
        <Card />
        <Card />
